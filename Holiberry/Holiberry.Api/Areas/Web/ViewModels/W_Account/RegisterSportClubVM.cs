...
{
    public class RegisterSportClubVM
    {
    ...
    public class RegisterSportClubVMValidator : AbstractValidator<RegisterSportClubVM>
    {
        public RegisterSportClubVMValidator()
        {
            RuleFor(a => a.Email)
            ...
            RuleFor(a => a.SportClubName)
                .NotNull().WithMessage("Pole nie może być puste")
                .NotEmpty().WithMessage("Pole nie może być puste")
                .MaximumLength(200).WithMessage("Pole może mieć maksymalnie 200 znaków");
        }
    }
}
