        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerLogLevel = table.Column<short>(nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(nullable: false),
                    Path = table.Column<string>(nullable: true),
                    QueryString = table.Column<string>(maxLength: 1000, nullable: true),
                    RequestBody = table.Column<string>(maxLength: 4000, nullable: true),
                    FileName = table.Column<string>(nullable: true),
                    ...
                    InnerMessage = table.Column<string>(maxLength: 8000, nullable: true),
                    StackTrace = table.Column<string>(maxLength: 8000, nullable: true),
                    RunSource = table.Column<string>(nullable: true),
